...
const Alphaedu = () => {
  ...
  const handleSendData = async () => {
    try {
        ...
        const response = await fetch('http://127.0.0.1:7777/gen', {
            method: 'POST',
            headers: {
  ...
  return (
    <Section>
      <div className="flex flex-col items-center justify-center">
        ...
        <input className="block text-sm w-2/4 text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-zinc-50 dark:placeholder-gray-400" id="file_input" type="file" />
        <label className="block pt-2 text-sm font-medium text-white dark:text-white" htmlFor="file_input">Or</label>
      </div>
      <div className="pt-2">
            <div className="relative flex md:auto">
                ...
                <textarea
                    ...
                    rows="10"
                    readOnly={false}
                    className="block p-2.5 w-3/4 mx-auto text-sm text-gray-900 bg-gray-50 rounded-lg border border-black focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ></textarea>
            </div>
            <div className="flex justify-center">
                <select
                    ...
                    className="bg-white rounded-md text-black absolute right-auto mt-2.5 mr-2.5"
                >
            ...
            <div
                className="mt-4 flex pt-6 items-center justify-center mx-auto col-start-1 row-start-3 self-center sm:mt-0 sm:col-start-2 sm:row-start-2 sm:row-span-2 lg:mt-6 lg:col-start-1 lg:row-start-3 lg:row-end-4">
                <button
