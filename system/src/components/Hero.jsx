...
import { curve, heroBackground, robot, robotwithabook} from "../assets";
    ...
    >
        <div className="container relative" >
            ...
            mb-[4rem] md:mb-20 lg:mb:[6rem]">
                ...
                Explore the universe of knowledge through each question: Refined system, boundless power! {' '}
                ...
                <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
                    A powerful tool enabling the generation of excellent questions, providing substantial assistance for both teachers and students.
                </p>
