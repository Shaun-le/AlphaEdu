    ...
    >
        <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
            <a className="block w-{12rem} xl:mr-8" href="#hero">
                <img src= "./src/assets/logo/header.png" width={190} height={40} alt="vieduqa" />
            </a>
            ...
            <nav className={`${openNavigation ? "flex":"hidden"} fixed top-[5rem] left-0 right-0 bottom-0 bg-n-8
              ...
              <div className="relative z-2 flex flex-col items-center m-auto lg:flex-row">
                {navigation.map((item) => (
                  ...
                  onClick={handleClick}
                  className={`block relative font-code text-2xl uppersace text-n-1
                  transition-colors hover:text-color-1 ${item.onlyMobile ? 'lg:hidden' : ''} px-6 py-6 md:py-8 
                  lg:-mr-0.25 lg:text-xs lg:font-semibold ${item.url === pathname.hash ? 'z-2 lg:text-n-1' : 'lg:text-n-1/50'}
